...
if (isset($_POST['guardar'])) {
	...
	if (!empty($apellidos) && !empty($telefono) && !empty($ciudad)  && !empty($telefono_cliente)) {
		...
		$consulta_insert = $con->prepare('INSERT INTO clientes(id_cliente,nombre_cliente,direccion_cliente,localidad_cliente,telefono_cliente) VALUES(:nombre,:apellidos,:telefono,:ciudad,:telefono_cliente)');
		...
		header('Refresh: 10; URL=Clientes.php');
		$ocultarAlerta = "";
	} else {
...
<body>
	...
	<div <?php echo $ocultarAlerta ?> class="alert alert-success alert-dismissible fade show" role="alert">
		<strong>Correcto!</strong> Cliente añadido.
		...
		<div class="card" style="width: 50rem;">
			<div class="card-body ">
				...
				<form action="" method="post">
					...
					<div class="form-group">
						<input type="text" name="telefono" placeholder="Direccion" class="form-control" required>
					</div>

					<div class="form-group">
						<input type="text" name="ciudad" placeholder="Localidad" class="form-control" required>
					</div>

					<div class="form-group">
						<input type="tel" name="telefono_cliente" placeholder="Telefono ej. 9994-23-23-24" class="form-control" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}-[0-9]{2}" title="Telefono ej. 9994-23-23-24" required>
					</div>
