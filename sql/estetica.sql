...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-11-2020 a las 02:35:13
...
(1, 'Jose damian Tun chim', 'calle 14', 'Timucuy', '9994-23-45-43'),
(5, 'damian', 'tc', 'mexico', '9994-67-78-89'),
(6, 'prueba', 'prueba', 'prueba', '9991-23-23-21');
...
--
ALTER TABLE `usuarios`
  MODIFY `id_usuario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2235;
