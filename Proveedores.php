...
$sentencia_select = $con->prepare('SELECT *FROM proveedores ORDER BY id_prov DESC');
							...
							<table class="table">
								...
								<?php foreach ($resultado as $fila) : ?>
									<tr>
										...
										<td><a href="updateProveedores.php?id=<?php echo $fila['id_servicios']; ?>" class="btn btn-info">Editar</a></td>
										<td><a href="tablas/deleteProveedores.php?id=<?php echo $fila['id_servicios']; ?>" class="btn btn-danger">Eliminar</a></td>
									</tr>
								<?php endforeach ?>
							</table>
						</div>
